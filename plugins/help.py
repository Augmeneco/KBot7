...
&#8195;bot_name вирус топ - выводит топ 10 стран по заражению, как аргумент может принять число стран
&#8195;bot_name вирус поиск - поиск информации о стране (на английском!) 
